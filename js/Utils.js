...
Dye.Utils= (function(){
     ...
     * returns h, s, and l in the set [0, 99], [0,359]
     *
    ...
    function getBrushSprite(game,r,g,b,a){
        ...
        var brush= game.make.sprite(0, 0, brushBmd);
        brush.anchor.set(0.5);



        fillBlack = function(pixel){
            if (r) pixel.r = r;
            if (g) pixel.g = g;
            if (b) pixel.b = b;
        ...
        brushBmd.processPixelRGB(fillBlack, this);
        brushBmd.render();
